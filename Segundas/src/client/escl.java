        		...
        		//	 boolean allConnect=false;
        			...
        			while(  tClient<numax)
        			{
                        ...
                        if (solicitud.equals("¿Quién es el servidor?")) {
                            ...
                            if (!clienteExistente) {
                                ...
                                if(tClient==0)
                                {
                                	sender.enviarMensaje("FD", clientAddresses[tClient], 5555);
                                }
                                else
                                {
                                	sender.enviarMensaje("FC", clientAddresses[tClient], 5555);
                                }
        			...
        			try
        			{
        			 ...
        			 try {
        		        ...
        		        File disco = new File("D:"); // Reemplaza "C:" con la letra de la unidad de disco que quieras calcular
        ...
        
	{
		...
		try
		{
		   ...
		   MensajeReceiver receiver = new MensajeReceiver(5555);
            ...
            String fallo=receiver.recibirMensaje();
